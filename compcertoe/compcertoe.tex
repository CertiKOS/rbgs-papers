...
\[
  \rho_1 \mathbin; (\rho_2 \oplus \rho_3) \mathbin; (\pi_\kw{bq} \oplus \pi_\kw{rb}) \mathbin; \ell
  \::\:
  L_\kw{bq}
    \le_{\mathbb{C} \twoheadrightarrow \mathbb{C}}
    \kw{Asm}(\kw{bq.s} + \kw{rb.s})
...
\[
  ...
  \::\:
  L_\kw{bq}
    \le_{\mathbb{C} \twoheadrightarrow \varnothing \mathbin; \mathbb{C}}
    \kw{Asm}(\kw{bq.s} + \kw{rb.s})
  \,.
\]
\end{example}
...
[TODO: bring the following example up-to-date]
