...
\begin{figure} %fig:cal {{{
  ...
  \quad
    ...
    % mem join
    \draw (0,6,3.5) [rounded corners] -- (0,1.5,3.5) -- (0,1,4);
    \draw (0,4,5) [rounded corners] -- (0,1.5,5) -- (0,1,4);
    ...
    % mem join
    \draw (8,5,3.5) [rounded corners] -- (8,1.5,3.5) -- (8,1,4);
    \draw (8,4,5) [rounded corners] -- (8,1.5,5) -- (8,1,4);
    \draw (8,1,4) -- (8,0,4);
  ...
  \raisebox{-0.5\height}{\begin{tikzpicture}[sdp]
    ...
    % <mem]^*
    \draw (0,5,3)
    [rounded corners] -- (0,3,3) -- (0,2,4);
    % [m_0>_*
    \draw (0,3,5)
    [rounded corners] -- (0,2.5,5) -- (0,2,4);

    % Nodes
    \node[tsn] at (2,0,3) {\Large$\,M\,$};
    \node[tsn] at (6,0,3) {\Large$\,L_1\,$};
    \node[tsn,bln] at (3.5,0,4) {};
    \node[tsn,bln] at (4.2,0,4) {};
    \node[scn,bln] at (0,5,3) {};
    \node[scn,bln] at (0,3,5) {};
