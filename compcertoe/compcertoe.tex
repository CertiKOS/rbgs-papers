...
\begin{alignat*}{2}
  ...
  &\quad \rightarrowtail && 0@m[b \mapsto deallocated]
\end{alignat*}
  \end{minipage}
    \quad
  \begin{minipage}[c][][c]{.45\textwidth}
\begin{alignat*}{2}
  ...
  \kw{main()}@m \\
  &\quad \rightarrowtail && ( \kw{read}(0, b, 100)@m[b \mapsto unspecified] \\
   &&& \leadsto \kw{len}(s)@m[b \mapsto s]) \\
  &\quad \rightarrowtail && (\kw{write}(1, b, \kw{len}(s))@m[b\mapsto \kw{rot13}(s)] \\
