...
The core of our framework's technical definition is given in \S\ref{sec:base}
...
\paragraph{Refinement-based Verification} %{{{

In the framework outlined above,
the source program serves as a specification,
the target program serves as the implementation,
and simulations establish a refinement
of the former by the latter.
As such,
this framework can be used as a rudimentary
...
[Some comments about why that's not good enough,
compared with Fig.~\ref{fig:spec}]
