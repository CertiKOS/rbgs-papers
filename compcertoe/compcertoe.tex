...
and can only verify systems whose functionality
...
and the existing implemention is again a closed ecosystem.
...
\begin{table}[b] % tbl:roadmap -- Roadmap and notations {{{
  \caption{
    Summary of
