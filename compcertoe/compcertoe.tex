...
embeds the simulation convention $\mathbf{R} : A \Leftrightarrow B$:
\begin{align*}
  (m_1, m_2) \bot \in \llbracket \mathbf{R} \rrbracket \: :\Leftrightarrow \: {}
   &\exists w \cdot m_1 \mathbf{R}^\que_w m_2
  \\[1.2ex]
  (m_1, m_2) (n_1, n_2) \top \in \llbracket \mathbf{R} \rrbracket \::\Leftrightarrow\: {}
   &\exists w \cdot m_1 \mathbf{R}^\que_w m_2 \:\wedge\:
   \neg n_1 \mathbf{R}^\ans_w n_2
  \\[1.2ex]
  (m_1, m_2) (n_1, n_2) s \in \llbracket \mathbf{R} \rrbracket \::\Leftrightarrow\: {}
   &\exists w \cdot m_1 \mathbf{R}^\que_w m_2 \:\wedge\:
   n_1 \mathbf{R}^\ans_w n_2 \:\wedge\:
     s \in \llbracket \mathbf{R} \rrbracket
  \,.
\end{align*}
...
\[
  ...
  \llbracket \phi_p^\kw{cc} \rrbracket \: : \:
      ...
      \le_{\llbracket \mathbbm{C} \rrbracket
        \twoheadrightarrow \llbracket\mathbbm{C}\rrbracket}
