...
remains beyong the scope of the present work.
\end{example}
%}}}
...
Its components are outlined in \autoref{tbl:artifact}
and discussed below.
...
such that only one of the two shares
is able to allocate new blocks at any given time,
