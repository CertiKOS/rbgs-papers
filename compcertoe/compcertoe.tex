...
and the $\mathbin@$ operation we have described above
is functorial in both arguments.
In fact,
parallel to our base model of \emph{active} components,
we can develop a \emph{passive} version
where lenses play the role of horizontal morphisms,
but which otherwise provides the same structures and
composition principles.
This is summarized in Table~\ref{tbl:roadmap}.
