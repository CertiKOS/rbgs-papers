...
$
  ...
  r
$,
where we use $\rightarrowtail$ to denote internal execution
...
The different language interfaces used for
...
$b : \bot \sqsubseteq (\bot\mathbin;\mathbb{C})$
...
$(\phi \mathbin; (\pi_1 \oplus \pi_2) \mathbin; \ell) \odot b \::\:
