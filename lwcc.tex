...
[I was hoping these examples could provide a way to illustrate
the concepts below,
...
Consequently,
semantic domains that and accurately account
...
happen to be technically identical,
...
\item[Preservation of system half-steps]
  ...
  $(s_1', s_2') \in R$.
  [That is, everything the target behavior does
  must be accounted for in the source]
