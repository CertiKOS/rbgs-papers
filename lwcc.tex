...
\title{A Certified Compiler for End-to-End Systems Verification}
...
for a foundational mathematical theory of components
...
has addressed various combinations of these requirements,
...
and fails to account for open systems.
We conjecture that
...
interface automata -> compositionality, open systems, refinement;
...
\subsection{Systemics of compilation} %{{{
...
(But really, need general effects for a real account.)
...
Various works seeks to extend to support some of these things:
