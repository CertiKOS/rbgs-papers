...
will then operate in terms
of this instrumented simulation convention.
The (existentially quantified) world invariant
$W \subseteq W_A \times W_B \times K^\sharp \times K^\flat$
used by the simulation
can then impose constraints on the encapsulated states.
...
\begin{lemma}[Layered composition of simulations] \label{thm:svcomp}
\[
  \begin{prooftree}
    \hypo{
      \Sigma_1^\sharp
