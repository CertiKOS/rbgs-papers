...
\]
When this component above is activated
...
which are characterized by the simulation properties:
\begin{equation} \label{eqn:compconj}
  \draftfig{0.07}{comp1} \qquad
  \draftfig{0.07}{comp2} \qquad
...
\[
  \kw{id}_{[U]}
  \le_{[R] \rightarrow \langle u \rangle^* \mathbin; \langle v \rangle_*}
  \kw{id}_{[V]}
  \qquad
