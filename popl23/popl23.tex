...
\begin{definition}
We do the thing where we add an existentially quantified
relation on encapsulated states,
which we use to extend the simulation convention.
\end{definition}

Show that compatible with composition, etc.
