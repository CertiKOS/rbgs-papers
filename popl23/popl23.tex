    ...
    &= \lambda_A^{-1} \cdot
       ...
       \begin{tikzpicture}[scale=0.35,inner sep=2pt,baseline=(z.base)]
         ...
         \draw (0, 2) node[above] {$B$}
           ...
           -- (1,0);
       \end{tikzpicture} \\
    &= \lambda_A^{-1} \mathbin; (\epsilon_A \otimes x) \mathbin; (w \otimes y) \mathbin; z
    \,.
\end{align*}
...
\begin{gather*}
  \begin{tikzpicture}[xscale=0.35,yscale=0.17]
    ...
    \draw[fill=white,rounded corners]
      ...
      (12,-1) rectangle (15,3) node[midway] {$L_\kw{bq}$};
  \end{tikzpicture}
  \\[1ex]
...
\begin{equation} \label{eqn:compconj}
  \begin{array}{r@{}l}
    \begin{tikzpicture}[scale=0.4,baseline] %{{{
      ...
      \begin{scope}
        ...
        \fill[pattern=crosshatch dots,opacity=0.1] (0,2) -- (1,2)
          [rounded corners] -- (1,1)
    ...
    \begin{tikzpicture}[scale=0.4,baseline] %{{{
      ...
      \begin{scope}
        ...
        \fill[pattern=crosshatch dots,opacity=0.1] (0,1)
          [rounded corners] -- (1,1)
    ...
    \begin{tikzpicture}[scale=0.4,baseline] %{{{
      ...
      \begin{scope}
        \fill[ACMBlue!50] (1,0)
          [rounded corners] -- (1,1)
          [sharp corners] -- (2,1) |- cycle;
        \fill[pattern=crosshatch dots,opacity=0.1] (0,0) -- (1,0)
          [rounded corners] -- (1,1)
    ...
    \begin{tikzpicture}[scale=0.4,baseline] %{{{
      ...
      \begin{scope}
        ...
        \fill[pattern=crosshatch dots,opacity=0.1] (1,2)
          [rounded corners] -- (1,1)
  ...
  \begin{tikzpicture}[scale=0.35,baseline=(R.base)] %{{{
    % Background
    \begin{scope}
      \fill[pattern=crosshatch dots,opacity=0.1] (0,0) rectangle (3,4);
...
\[
  \begin{tikzpicture}[xscale=0.60,yscale=0.3]
    ...
    \begin{scope}
      \footnotesize
      \draw (2,11)
        node[above] (x) {$(\mathcal{C} \mathbin@ \kw{mem} \mathbin@ \langle p_0 \rangle_*)$}
...
with
an additional state component $U \in \mathbf{Lens}$.

\begin{definition} \label{def:slts}
Consider a category $\mathbf{C}$
equipped with a functor
${\star} : \mathbf{C} \times \mathbf{Lens} \rightarrow \mathbf{C}$
