...
In this section,
we summarize the semantic model used in CompCertO
and describe new constructions within that model
which will be useful for our application.
...
\begin{definition}[Language Interface] \label{def:li}
\end{definition}
