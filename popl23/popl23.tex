...
making it possible to introduce of module-local state
by expressing constraints on the environment.
However,
neither Compositional CompCert nor CompCertM
...
Indeed,
categories with feedback could provide a basis for encapsulation
