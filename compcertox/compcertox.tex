...
Building on these ideas and constructions,
\citet{rbgs-cal}

[brief summary of interaction specification monad +
strategy specifications based on the exposition above]
...
\subsection{Interpretation in $\ISpec$}
