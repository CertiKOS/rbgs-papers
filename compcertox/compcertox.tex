...
\begin{example}
  Bounded queue fits into this model
\end{example}
...
In this section,
we investigate the correspondence
between the abstract layers
the CompCert layers.

The correctness criteria states that a strategy
