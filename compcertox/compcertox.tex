...
\title{%
  Specification, Abstraction, and Refinement
...
Things that should go in the title:
\begin{itemize}
  \item Something about unifying certified compilation and
    certified abstraction layers
  \item Adjunctions model the relationship between
    levels of abstraction
\end{itemize}
Important ideas:
\begin{itemize}
  \item Semantics not just a theoretical exercise
    but should provide tools for engineering
  \item Semantic constructions
    should mirror the way engineers think about systems
\end{itemize}
