...
where the details on memory locations
are articulated.
We define
...
is similar to a compiler pass CompCert
where the strategy is the source program
and the Clight code is the target program.
