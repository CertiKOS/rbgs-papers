...
\[
  ...
  \circ L^\sharp
  \sqsubseteq_{1 \rightarrow \hat{R}}
  \llbracket \kw{Clight}(N + M) \rrbracket
  @D^\flat \circ L^\flat
\]
...
and prevents potential unwanted leakage.
...
%
  ...
  and we relate natural numbers with machine integers,
  ...
  and bounded queue respectively as
$
