...
[Explain how to embed CompCertO's simulation conventions as adjunctions,
and simulations as refinement]
...
In this section,
we construct a trace semantics capable of accomodating
dual nondeterminism.
The type structure of our model
is inspired by Reddy's work on \emph{object-based semantics},
and provides a fine-grained control of
the shape of traces.
