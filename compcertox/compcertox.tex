...
and code snippets as our staring point.
...
with all joins and (consequently) all meets.
This means in particular that $L$
has a least element $\bot = \bigvee \varnothing$
and a greatest element $\top = \bigwedge \varnothing$.
