...
and use it to characterize and verify
...
\begin{itemize}
  ...
  \item As I've outlined before,
    effect signatures come with their own $\dagger$,
    but there some aspects of it we would need to figure out.
\end{itemize}
...
CompCertO denotational semantics with whatever tweaks we need.
...
\[
  ...
  \quad \mapsto \quad
  \begin{array}{cc}
    \mathbb{R}^\circ : A \multimap B & \mathbb{R}^\bullet : B \multimap A \\
    \mathbb{R}_\circ : B \multimap A & \mathbb{R}_\bullet : A \multimap B
  \end{array}
  \quad \mapsto \quad
  \begin{array}{cc}
    {\dagger}\mathbb{R}^\circ : {\dagger}A \multimap {\dagger}B &
    {\dagger}\mathbb{R}^\bullet : {\dagger}B \multimap {\dagger}A \\
    {\dagger}\mathbb{R}_\circ : {\dagger}B \multimap {\dagger}A &
    {\dagger}\mathbb{R}_\bullet : {\dagger}A \multimap {\dagger}B
  \end{array}
\]
Establish Galois connection properties
and corresponding soundness theorem.
