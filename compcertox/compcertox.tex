...
\section{Game Semantics and Dual Nondeterminism} \label{sec:rbgs} %{{{
...
the majority of layers specifications
...
has type
$L_\kw{rb}: 1 \rightarrow \mathcal{C}@(D_\kw{rb}\times \kw{mem})$
