...
%  \vspace*{5em}
%  \Huge
%  CompCertO\hspace{-0.5ex}\raisebox{-0.5ex}{X}! \\[2em]
%  \Large
%  J\'er\'emie Koenig \\[1em]
%  \today
%\end{titlepage}

%\begin{abstract}
%  This note explains how
%  CompCertO can be used to replace CompCertX,
%  and outlines some extensions made possible
%  by the features of CompCertO.
%\end{abstract}
...
\begin{figure}[h]
  \begin{center}
    \begin{tikzcd}[row sep=1cm, column sep=1.5cm]
      1 \ar[d, double, dash] \ar[rrr, ->>, "L_1"] &&&
      \mathcal{C}@K_1
        \ar[d, <->, "R"]
        \ar[r, "\llbracket C \rrbracket@K_1"] &
      \mathcal{C}@K_1
        \ar[ddd, <->, "R \cdot S"]
      \\
      1 \ar[d, double, dash] \ar[rr, ->>, "L_2"] &&
      \mathcal{C}@K_2
        \ar[d, <->, "S"]
        \ar[r, ->>, "\llbracket M \rrbracket@K_2"] &
      \mathcal{C}@K_2
        \ar[d, <->, "S"]
      \\
      1 \ar[dd, double, dash] \ar[r, ->>, "L_3"] &
      \mathcal{C}@K_3
        \ar[d, double, dash] 
        \ar[r, ->>, "\llbracket N \rrbracket@K_3"] &
      \mathcal{C}@K_3
        \ar[r, ->>, "\llbracket M \rrbracket@K_3"] &
      \mathcal{C}@K_3
        \ar[d, double, dash]
      \\ &
      \mathcal{C}@K_3
        \ar[d, double, dash] 
        \ar[rr, ->>, "\llbracket M + N \rrbracket@K_3"] &&
      \mathcal{C}@K_3
        \ar[r, ->>, "\llbracket C \rrbracket@K_3"] &
      \mathcal{C}@K_3
        \ar[d, double, dash] 
      \\
      1 \ar[r, ->>, "L_3"] &
      \mathcal{C}@K_3
        \ar[rrr, ->>, "\llbracket C + M + N \rrbracket@K_3"] &&&
      \mathcal{C}@K_3
    \end{tikzcd}
  \end{center}
  \caption{%
