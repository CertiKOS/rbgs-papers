...
semantics, the refinement calculus, and algebraic effects can provide a
...
the framework of \emph{algebraic effects and handlers} \cite{eff}
...
evaluates to the unit value $*$ when the proposition is true,
...
by introducing arbitrary demonic choice and
by relaxing constraints over angelic choices.
%Specifically,
