...
general-purpose setting where these models and correctness proofs
can be embedded and linked together to
...
with the \emph{free completely distributive completion},
to obtain \emph{strategy specifications} equipped with
arbitrary angelic and demonic choices
and ordered by a generalization of alternating refinement.
This provides a novel approach to game semantics of nondeterminism.
