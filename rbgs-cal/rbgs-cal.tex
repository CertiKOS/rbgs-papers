...
\jk{The form of traces as well.
  I can try to adapt them but traces in \S3 are odd-length and start
  with a system move.}
%%%%
...
\begin{theorem}
Define
$\mu := \llbracket M \rrbracket @ S_1 \circ \llbracket L_1 \rrbracket$.
Then:
\[
  R^*_{E_2} \!\circ \llbracket L_2 \rrbracket \sqsubseteq \mu
  \: \Leftrightarrow \:
  L_1 \vdash_R M : L_2
  \: \Leftrightarrow \:
  \llbracket L_2 \rrbracket \sqsubseteq R_*^{E_2} \!\circ \mu \,.
\]
\begin{proof}
