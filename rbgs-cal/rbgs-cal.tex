...
more so in the context of games.
By embracing a model permitting both
kinds of determinism to the maximal extent,
[from the start, and baking it into the construction of strategies,
small initial cost in complexity at the start
but huge savings when it comes to the definition and
algebraic properties of refinement,
for example compare w/ \citet{gseia}]
[other interesting effect of this is decoupling somewhat
the polarity of moves vs. choice dynamics
of strategies.]

[Disclaim limitation and look to the future.]
