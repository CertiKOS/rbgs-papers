...
which can be used to interpret dual nondeterminism
as an effect.
We build on this by drawing from the research
...
In this work,
we will use effect signatures to represent
the possible external interactions
of a computation,
but will not focus on the equational theory component
of the framework of algebraic effects.
The \emph{interaction monad} $\mathcal{I}_E$
presented in \S\ref{sec:intmonad}
combines dual nondeterminism with
