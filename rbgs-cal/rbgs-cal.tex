...
\[
    \kw{run} \cdot
    \underline{\kw{rd}_\kw{n}} \cdot n \cdot
    \underline{\kw{wr}_\kw{n}[2n]} \cdot \kw{ok} \cdot
...
\begin{align*}
  ...
  &
      \begin{array}{l@{\,}l}
        = \{ & \epsilon, \\ &
        \kw{run} \cdot
        \underline{\kw{rd}_\kw{n}} ,
        \\ &
        \kw{run} \cdot
        \underline{\kw{rd}_\kw{n}} \cdot n \cdot
        \underline{\kw{wr}_\kw{n}[2n]} ,
        \\ &
        \kw{run} \cdot
        \underline{\kw{rd}_\kw{n}} \cdot n \cdot
        \underline{\kw{wr}_\kw{n}[2n]} \cdot \kw{ok} \cdot
...
\[
  \sigma \subseteq
    ...
    {\downarrow}(
      \kw{run} \cdot
      \underline{\kw{rd}_\kw{n}} \cdot n \cdot
      \underline{\kw{wr}_\kw{n}[2n + \delta]} \cdot \kw{ok} \cdot
      \underline{\kw{done}})
\]
...
\begin{align*}
  ...
  & \, =
    \{ \epsilon,  \:
       \kw{run} \cdot \underline{\kw{rd}_\kw{n}} \cdot n
       \mid n \in \mathbb{N} \} \,.
\end{align*}
...
\[
  \sigma' :=
    ...
    \phi \big(
        \kw{run} \cdot
        \underline{\kw{rd}_\kw{n}} \cdot n \cdot
        \underline{\kw{wr}_\kw{n}[2n + f_n]} \cdot \kw{ok} \cdot
