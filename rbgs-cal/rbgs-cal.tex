...
\begin{align*}
  ...
  \kw{assert}(P) &:= \bigsqcup \{ \kw{skip} \mid P \} \\
  \kw{magic} &:= \bigsqcap \varnothing &
  \kw{assume}(P) &:= \bigsqcap \{ \kw{skip} \mid P \}
\end{align*}
