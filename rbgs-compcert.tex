...
\[ \gamma(\llbracket p \rrbracket_s) \sqsubseteq
...
and we have modified and proved the CompCert correctness theorem
in the way outlined above.
In the following section,
we outline how this work may be used
in the larger context of compositional verification.
