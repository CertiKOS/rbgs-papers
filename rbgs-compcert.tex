...
$L$ is a labelled transition system for the game $A \twoheadrightarrow B$.
\end{definition}
...
\begin{gather*}
  ...
  \: :\Leftrightarrow \:
  f \Vdash m_1 \hookrightarrow m_2 \,,
\end{gather*}
...
\section{End-to-end correctness} \label{sec:simalg} %{{{
...
\begin{gather*}
  {\cdot} \ifr{{\scref} \times {\scref} \rightarrow
               {\scref}} {\cdot}
  \\
...
\subsection{Simplifying the simulation conventions} %{{{
