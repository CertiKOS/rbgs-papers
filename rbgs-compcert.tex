...
is then modeled as a strategy for the system,
which specifies its the next move
for all relevant positions in the game.

Positions are usually identified with sequences of moves,
and strategies with sets of positions
...
\subsubsection{Type Structure} \label{sec:mainideas:gs:types} %{{{
