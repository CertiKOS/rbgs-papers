...
Having described the passes of CompCertO
and the types of their simulation proofs in terms of
simulation conventions,
we move on to the problem of composing successive passes
to obtain a certified compiler.
To this end,
we first define the composition of simulation conventions.
...
This allows us to formulate the following composition property
