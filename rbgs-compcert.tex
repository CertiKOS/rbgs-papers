...
in the reliability and security of the resulting systems.
...
their correctness proofs are composed into
...
and of the final assembly program emitted by the compiler.
...
explaining how a C call is realized at the assembly level.
...
Denotational semantics is more compositional,
and computes the meaning of a program fragment (its denotation)
from the meanings of its constituents.
This makes denotational semantics
...
first-order types
makes our game model extremely simple.
Nevertheless,
...
which treats silent divergence as a specific behavior.
...
The non-deterministic, infinite iteration of $f$ is:
\[
...
and requiring that the index decrease
...
we use a transition system which keeps track,
of the currently active behavior, and
...
\[
    \forall p_s \,.\,
      ...
      \kw{Clight} \llbracket p_s \rrbracket
      \le{\mathbb{R}_\kw{CompCert} \Rightarrow \mathbb{R}_\kw{CompCert}}
      \kw{Asm} \llbracket p_t \rrbracket \,.
\]
...
have been paritcularly fruitful.
