...
\begin{figure} % fig:cklr-def (Definition of CKLRs) {{{
  ...
  \caption{Defining properties of CKLRs.
    Note the correspondance between the relational properties
    and the types of the operations outlined in Fig.~\ref{fig:mm}.}
  \label{fig:cklr-def}
\end{figure}
%}}}
...
\begin{gather*}
  \kw{injp} :=
    ...
    \rangle
  \\
  (f, m_1, m_2) \Vdash R^\kw{mem}_\kw{injp}
  \:\: := \:\:
  f \Vdash {\hookrightarrow_\kw{m}} \,,
\end{gather*}
...
For details, please refer to Appendix~\ref{sec:simalg}
