...
\[
  \begin{array}{cc}
    ...
    \\[1em]
    \AxiomC{$k \stackrel{m}{\rightarrow_\sigma} s$}
    \UnaryInfC{$(k, \iota) \stackrel{m}{\rightarrow} (s, \kw{O} :: \iota)$}
    \DisplayProof
    &
    \AxiomC{$s \stackrel{q}{\rightarrow_\sigma} k$}
    \AxiomC{$k \:\#_\sigma\: q$}
    \BinaryInfC{$(s, \iota) \stackrel{q}{\rightarrow_\sigma} (k, \iota)$}
    \DisplayProof
    \\[1.5em]
    \AxiomC{$s \stackrel{n}{\rightarrow_\sigma} k$}
    \AxiomC{$k \stackrel{n}{\rightarrow_\sigma} s'$}
    \BinaryInfC{$(s, \kw{P} :: \iota) \stackrel{\tau}{\rightarrow} (s', \iota)$}
    \DisplayProof
    &
    \AxiomC{$s \stackrel{q}{\rightarrow_\sigma} k$}
    \AxiomC{$k \stackrel{q}{\rightarrow_\sigma} s'$}
    \BinaryInfC{$(s, \iota) \stackrel{\tau}{\rightarrow} (s', \kw{P} :: \iota)$}
    \DisplayProof
    \\[1.5em]
    \AxiomC{$s \stackrel{n}{\rightarrow_\sigma} k$}
    \UnaryInfC{$(s, \kw{O} :: \iota) \stackrel{n}{\rightarrow} (k, \iota)$}
    \DisplayProof
    &
    \AxiomC{$k \stackrel{r}{\rightarrow_\sigma} s$}
    \UnaryInfC{$(k, \iota) \stackrel{r}{\rightarrow} (s, \iota)$}
    \DisplayProof
    \\[1.5em]
    \AxiomC{$s \stackrel{\tau}{\rightarrow_\sigma} s'$}
    \UnaryInfC{$(s, \iota) \stackrel{\tau}{\rightarrow} (s', \iota)$}
  ...
  \end{array}
\]
The initial continuation is $(k_{0,\sigma}, \varepsilon)$.
\end{definition}
