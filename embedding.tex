...
%The small-step resolution operator $\kw{R}(L)$
%uses a stack of states of $L$ as its own states.
%Given $L = (S_L, I_L, F_L, {\rightarrow_L}$,
%we can define $R(L) = (S, I, L, {\rightarrow})$ in the following way:
%\begin{align*}
%  S &:= S_L^* \\
