...
\cite{qompcert,sepcompcert,compcompcert,compcerttso,compcertshm,compcertm,cpp15},
...
heterogeneous systems, involving for instance hardware components.
...
A game is defined by a set of moves $M$
...
\item[External calls]
  ...
  $(s_2, n_2, s_2') \in Y_2$ and
  $w_B \Vdash s_1' \mathrel{R} s_2'$.
\item[Final states]
  For $w_B \Vdash s_1 \mathrel{R_i} s_2$
...
\begin{figure} % fig:hcomp {{{
    ...
    \begin{gather*}
     ...
     {\begin{prooftree}
        \hypo{s \mathrel{X_i} q}
        \hypo{\forall j \,.\, q \notin D_j}
        \infer2{(i, s) \, k \mathrel{X} q}
      \end{prooftree}}
      \qquad
     {\begin{prooftree}
        \hypo{(s, r, s') \in Y_i}
        \infer1{((i, s) \, k ,\, r ,\, (i, s') \, k) \in Y}
      \end{prooftree}}
    \end{gather*}
...
\[
  \begin{prooftree}
    ...
    \hypo{L_1' \le_{\mathbb{R} \twoheadrightarrow \mathbb{R}} L_2'}
    \infer2{L_1 \oplus L_1' \le_{\mathbb{R} \rightarrow \mathbb{R}} L_2 \oplus L_2'}
  \end{prooftree}
\]
\begin{proof}
...
\begin{figure} % fig:cklr-def (Definition of CKLRs) {{{
  ...
  \caption{Defining properties of CKLRs.
    ...
    the types of the operations outlined in Fig.~\ref{fig:mm}.}
  \label{fig:cklr-def}
\end{figure}
%}}}
...
\[
  \begin{prooftree}
    ...
    \infer1{w \Vdash (b_1, o_1 + \delta) \mathrel{R^\kw{ptr}} (b_2, o_2 + \delta)}
  \end{prooftree}
\]
