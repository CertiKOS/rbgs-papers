...
I will write $b \in \mathbb{B}$ for the individual behaviors
defined above.
CompCert characterizes the externally observable behavior
...
This example only illustrates the nondeterminism
introduced by the step relation $\rightarrow$,
but this phenomenon involves initial and final states as well.
...
\[
  \bigsqcap A
\]
Therefore CompCert uses the following form of
...
We defined general Kripke relations in \S\ref{sec:klr}.
