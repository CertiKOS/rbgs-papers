...
defined by:
\begin{align*}
  \underline{v} f &:= f(v) & v &\in X \\
  \underline{m}(t_n)_{n \in N} f &:=
    \underline{m}(t_n f)_{n \in N} & (m:N) &\in E
\end{align*}
\end{definition}
%}}}
...
\begin{align*}
  \underline{v}^\alpha &:= v & v &\in A \\
  \underline{m}(t_n)_{n \in N}^\alpha &:=
...
is given by:
\[
  \mathbf{I}^m := \underline{m}(\underline{n})_{n \in N}
  \,.
\]
