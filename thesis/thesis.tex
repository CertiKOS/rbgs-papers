...
\[
  ...
  \exists \, \iota \:\bdot\:
    ...
    m_2 \stackrel{\iota}{\hookrightarrow} m_1
\]
\[
  \begin{tikzcd}[row sep=large]
...
we will use the order embedding associated with $\mathrm{FCD}$
implicitly,
...
\end{align*}
We extend the notations used for $\mathrm{FCD}$
...
To an extent, this is a concious design choice.
