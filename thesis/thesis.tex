...
and between an element $v \in X$ of the set of variables
...
\subsection{Interpretations as strategies} %{{{
...
This is in essence the \emph{layer calculus}
...
and it is not possible to compose horizontally
