...
% Avoid orphans -- need to tweak figure positioning etc.
%\clubpenalty = 10000
%\widowpenalty = 10000
...
incorporating certified compilation
to any such effort is crucial.
However,
it presents a number of new challenges.
...
Through techniques developped in \S\ref{sec:cklr} and \S\ref{sec:callconv},
...
\newcommand{\colorA}{ACMDarkBlue!50}
\newcommand{\colorB}{ACMRed!50}
