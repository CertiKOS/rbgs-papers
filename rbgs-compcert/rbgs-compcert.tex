...
We discuss with related work in \S\ref{sec:rw}
and conclude with a short evaluation
of the significance of our results in \S\ref{sec:concl}.
...
\begin{table} % tbl:compcerts {{{
  \small
  \begin{tabular}{l@{\qquad}c@{\qquad}c@{\:}c@{\:}c@{\:}c@{\:}c}
    \hline
