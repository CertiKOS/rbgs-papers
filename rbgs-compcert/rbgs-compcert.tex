...
however the assembly answer is expected to have popped the return address
and branched to it, setting the program counter $\kw{\%pc}$ accordingly.
In addition,
...
\subsection{Refinement of simulation conventions} %{{{
...
are families of predicates respectively on $A^\que, A^\ans$
indexed by $W$.
\end{definition}
%}}}
