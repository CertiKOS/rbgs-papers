...
\section{Conclusion} \label{sec:effort} %{{{
...
which allowed us to formulate a very precise correctness theorem
and offered much flexibility
in the formalization and deployment of
our composition techniques.
It is worth noting that
the resulting structures have much in common with
those found in particular in the research on
...
required for this incredible undertaking.
