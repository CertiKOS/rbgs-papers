...
\begin{figure} % fig:compc {{{
  ...
  \begin{tikzpicture}[yscale=0.36,thick]
    ...
    \begin{scope}[xshift=-1.52cm,xscale=-0.11]
      ...
      \draw (0, 9) coordinate (AO3) -- (16, 9) coordinate (CLO) node[left] {$\mathcal{C\!L}$};
      \draw (0, 4) coordinate (SO1) -- (16, 4) coordinate (LMO) node[left] {$\mathcal{L\!M}$};
      \draw (0, 2) coordinate (GO2) -- (16, 2) coordinate (MAO) node[left] {$\mathcal{M\!A}$};
...
\kw{injp}, $\mathcal{C\!L}$, and $\mathcal{L\!M}$
in particular
