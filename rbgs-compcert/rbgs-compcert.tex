...
In particular, the introduction %a decade ago
...
we outline possible applications of \autoref{thm:compc},
...
then to $L_2$,
then back to the environment again,
...
was designed specifically for the verification of CompCertO.
It is admittedly unlikely that it could adequately capture
the complexity of hardware communication
or the concurrency inherent in composite systems
...
As a first step we present a detailed comparison
