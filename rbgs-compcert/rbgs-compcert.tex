...
(\S\ref{sec:sem:ref}).
To facilitate reasoning about CompCert's languages and simulation proofs,
...
and finally returns from the incoming call
with the result~$r$.
...
\autoref{tbl:notations} summarizes all of these notations,
