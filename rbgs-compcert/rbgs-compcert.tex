...
we examine applications of \autoref{thm:compc},
...
%because it involves components which are both
%covariant and contravariant in CKLRs.
%However,
%since it encodes constraints
%which are preserved by all memory operations,
