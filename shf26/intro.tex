...
into semantic frameworks of this kind
...
where compositionality only operates within the boundaries
of this completed system.
...
shows that frameworks combining
game semantics,
...
\item First, we will extend our heterogeneous refinement framework,
  ...
  we will pay particular attention to the interplay between
...
\item Second,
  ...
  and that a compiler correctness statement for CompCert
