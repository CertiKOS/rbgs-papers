...
A typical compositional verification concern is to
...
relying on state encapsulation
harder to express.
...
they must be expressed within a common framework.
However, providing a model flexible enough
...
one of few large certified artifacts
...
we had to extend the CompCert memory model
and language semantics to treat certain external calls
