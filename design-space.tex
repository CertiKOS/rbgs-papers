...
Then we could introduce another syntactic operation
...
but we may obtain some simplification by decoupling some aspects of it
as syntactic linking of multi-module components.
